import { ADDITIONAL_VALUE_PER_PAGE, DEFAULT_VALUE_PER_PAGE } from '../constants/constants';
import { IDataResult } from '../types/types';

const changePerPage = (items: IDataResult[], currentPage: number, perPage: number) => {
